...
echo "Importing a dump from %mysql_origin_database% database from host" ^
    "%mysql_origin_database%..."
mysqldump.exe -h %mysql_origin_host% ^
    -P %mysql_origin_port% ^
...
mysqladmin.exe -h %mysql_destination_host% ^
...
mysql.exe -h %mysql_destination_host% ^
    -P %mysql_destination_port% ^
    %mysql_origin_database% < %temporal_dump_file_name%
